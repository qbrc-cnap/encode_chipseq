...
def map_inputs(user, all_data, data_name, id_list):
    ...
    d = {}
    d[id_list[0]] = j[genome_choice]['ref_fa']
    d[id_list[1]] = j[genome_choice]['bwa_idx_tar']
    d[id_list[2]] = j[genome_choice]['chrsz']
    d[id_list[3]] = j[genome_choice]['blacklist']
    d[id_list[4]] = j[genome_choice]['gensz']
    return d 
