...
workflow chip {
	...
	Array[File] reordered_input_fastqs = organize_inputs.ordered_inputs
	#####################
	...
	Array[File] merged_fastqs_R1 = 	reordered_pulldown_fastqs
	Array[File?] merged_fastqs_R2 = []
	#Array[File?] ctl_merged_fastqs_R1 = []
	Array[File] ctl_merged_fastqs_R1 = reordered_input_fastqs
...
task organize_inputs {
	...
	runtime {
		docker: "docker.io/blawney/encode_chipseq:v0.1"
		cpu : 1
		memory : "8000 MB"
		time : 2
